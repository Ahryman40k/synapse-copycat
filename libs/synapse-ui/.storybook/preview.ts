...
import { withThemeSwitcher } from './theme-selector/theme-switcher'
...
export default {
  parameters: {
    backgrounds: {
      ...
      values: [
        { name: 'default-light', value: '#fff' },
        { name: 'default-dark', value: '#000' }, {
          name: 'component-driven',
          value: `#000 center / cover no-repeat url(data:image/svg+xml;base64,${img})`,
        }, {
          name: 'image-url',
          value: '#000 center / cover no-repeat url(https://cdn3.vectorstock.com/i/1000x1000/51/57/vintage-neon-electro-direction-two-green-vector-9045157.jpg)'
        }
      ]
    },
    docs: {
