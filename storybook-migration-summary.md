...
- `npx storybook@latest automigrate --config-dir apps/synapse-copycat/.storybook`

- `npx storybook@latest automigrate --config-dir libs/synapse-ui/.storybook`
...
- `npx storybook@latest automigrate --config-dir tools/sb-theme-switcher/.storybook`
